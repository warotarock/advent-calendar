...
export class VectorStrokeEditLogic {
     ...
     *
     */
    static getStepDistanceAndCornerOptimizedStroke(source_stroke, baseStepDistance, fineStepDistance) {
    ...
    static searchLinearSegment(points, startIndex, isForwardSearch, stepDistance, maxCurvingAngle) {
        let resultIndex = -1;
        let lastPoint = null;
        let firstPoint = null;
            ...
            if (isFiexdPoint || isCorner) {
                ...
                if (!isFiexdPoint) {
                    ...
                    if (isTwoPointCorner
                        ...
                        let isAvailable = VectorMath.crossPoint(this.crossingPoint, backward_point1.location, backward_point2.location, forward_point1.location, forward_point2.location);
