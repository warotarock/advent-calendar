...
(function (ManualTracingTool) {
    ...
    var Tool_ScratchLine = (function (_super) {
        ...
        Tool_ScratchLine.prototype.mouseUp = function (e, env) {
            ...
            if (e.isRightButtonReleased()) {
                // Finish selectiong a line
                this.lineSingleHitTester.execute(env.document.layers, e.location[0], e.location[1], env.mouseCursorRadius);
    ...
    var Command_ExtrudeLine = (function (_super) {
        ...
        Command_ExtrudeLine.prototype.execute = function () {
            this.errorCheck();
        ...
        Command_ExtrudeLine.prototype.undo = function () {
            this.targetLine.points = this.editLine.oldPointList;
        };
        Command_ExtrudeLine.prototype.redo = function () {
    ...
    var Command_ScratchLine = (function (_super) {
        ...
        Command_ScratchLine.prototype.execute = function () {
            this.errorCheck();
            this.prepareEditPoints();
            this.redo();
        };
        ...
        Command_ScratchLine.prototype.undo = function () {
            for (var _i = 0, _a = this.editPoints; _i < _a.length; _i++) {
                var editPoint = _a[_i];
                var targetPoint = editPoint.pair.targetPoint;
        ...
        Command_ScratchLine.prototype.redo = function () {
            for (var _i = 0, _a = this.editPoints; _i < _a.length; _i++) {
                var editPoint = _a[_i];
                var targetPoint = editPoint.pair.targetPoint;
