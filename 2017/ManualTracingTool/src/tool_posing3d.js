...
(function (ManualTracingTool) {
    ...
    var Command_Posing3d_LocateHead = (function (_super) {
        ...
        Command_Posing3d_LocateHead.prototype.execute = function () {
            this.errorCheck();
        };
        Command_Posing3d_LocateHead.prototype.undo = function () {
        };
        Command_Posing3d_LocateHead.prototype.redo = function () {
            this.execute();
        };
