...
(function (ManualTracingTool) {
    ...
    var Tool_Select_BrushSelet = (function (_super) {
        ...
        Tool_Select_BrushSelet.prototype.processSelectionEdit = function (e, env) {
            ...
            this.logic_BrushSelect.process(env.document.layers, e.location[0], e.location[1], env.mouseCursorRadius);
        };
    ...
    var Command_Select = (function (_super) {
        ...
        Command_Select.prototype.execute = function () {
            this.errorCheck();
        ...
        Command_Select.prototype.undo = function () {
        ...
        Command_Select.prototype.redo = function () {
            for (var _i = 0, _a = this.selectedPoints; _i < _a.length; _i++) {
                var selPoint = _a[_i];
