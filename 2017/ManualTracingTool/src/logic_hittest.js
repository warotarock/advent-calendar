...
(function (ManualTracingTool) {
    ...
    var HitTest_LinePoint_LocationalDistanceBase = (function (_super) {
        ...
        HitTest_LinePoint_LocationalDistanceBase.prototype.execute = function (layers, x, y, minDistance) {
            this.startProcess();
            this.process(layers, x, y, minDistance);
            this.endProcess();
        };
        HitTest_LinePoint_LocationalDistanceBase.prototype.startProcess = function () {
            this.beforeHitTest();
        };
        HitTest_LinePoint_LocationalDistanceBase.prototype.process = function (layers, x, y, minDistance) {
            this.exitPointHitTest = false;
        ...
        HitTest_LinePoint_LocationalDistanceBase.prototype.hitTestRecursive = function (layers, x, y, minDistance) {
            for (var _i = 0, layers_1 = layers; _i < layers_1.length; _i++) {
                ...
                if (layer.type == ManualTracingTool.LayerTypeID.vectorLayer) {
                    ...
                    for (var _a = 0, _b = vectorLayer.groups; _a < _b.length; _a++) {
                        var group = _b[_a];
