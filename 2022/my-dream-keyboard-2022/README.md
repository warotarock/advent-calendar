...
（このタイトルには再販しないかなーというそこはかとない淡い期待をこめて書いています）
...
実はキーボードアドベントカレンダー向けに書いていたのですが埋まってしまったので、タイパーアドベントカレンダーに場所をお借りさせていただきました。厳密にはキーボード自作してないのと、日本語入力配列も作ったことがある人なので、なにとぞご容赦ください…。
