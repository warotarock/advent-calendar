...
## DynaBook DB65P/4MC
究極のスタートは中学生のときに学校で触ったPC-9801時代のフルキーボードなんですが、次が高校生のときに親に買ってもらった最初（で最後の）のノートパソコンがDynaBookでした。

たぶんですが沖電気製のキーボードです。これは押し心地がソフトで指に優しくて好きでした。パンタグラフ式、キーピッチは19mm、キーストロークは2mmくらいです。
...
カスタマイズ性もすばらしくて、専用のツールでほとんどなんでも設定でします。
...
他のキーも干渉しないように丸めたりしています。F1の列は最上段なので丸めていません。Enterキーは右側に小指をひっかけるための山があります。

[![夢のキートップ2](img012_s.jpg)](img012.jpg)

おまけで二枚にしてみました。CGなので一瞬で二枚にできます（むなしいけど）

[![夢のおまけ](my-dream-keyboard004_s.jpg)](my-dream-keyboard004.jpg)

# おわりに

今回はCGで理想のキーボードを描いてみました。ツヤツヤした画像を見たら、なんか幸せな気分になりました。

あと、今回の記事を書いているとき、ふと未来の世界では身体を動かすと楽な位置にキーボードが勝手に動いてくれたらいいのになーと思ったりもしました。キーボードを二枚使っているのは健康のためなんです。
